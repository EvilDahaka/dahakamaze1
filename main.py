...
monster1 = Enemy('shutterstock_788611123-[Converted]-49.png', win_width - 80, 180, 120, 120, 2)
monster2 = Enemy('shutterstock_788611123-[Converted]-49.png', win_width - 80, 100, 120, 120, 2)
...
while run:
   ...
   if not finish:
       ...
       sprite.groupcollide(monsters, barriers, True, True)
